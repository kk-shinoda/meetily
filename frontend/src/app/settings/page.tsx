...
import { ArrowLeft, Settings2, Mic, Database as DatabaseIcon, SparkleIcon, FlaskConical, Radar } from 'lucide-react';
...
import { MeetingDetectionSettings } from '@/components/MeetingDetection/MeetingDetectionSettings'; // fork
...
const TABS = [
  ...
  { value: 'autoRecord', label: 'Auto Record', icon: Radar }, // fork
